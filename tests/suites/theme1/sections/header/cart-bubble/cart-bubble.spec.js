...
test.describe('Drawer style - Cart bubble - Adding from product form, quantity input is present', () => {
...
test.describe('Drawer style - Cart bubble - Adding from product form, quantity input is not present', () => {
  test.beforeEach(async ({ page }) => {
