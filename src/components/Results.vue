  ...
  <template v-if="isReady">
    <div class="result-container page-width">
      <div class="welcome">
        ...
        <button
          class="cta button step-button step-button-next"
        ...
        <span class="cta__muted muted-small"
      ...
      <template v-for="(concern, index) in results.skin" :key="index + 'skin'">
        <template v-if="concernDisplay(concern.title)">
          <div
            :class="
              (index % 2 == 0
                ? 'result-card-reverse animation-element'
                : 'result-card animation-element') +
              (index === 0 ? ' in-view' : '')
            "
          >
            ...
            <div class="image-about">
              <div class="quote-container">
                ...
                <blockquote class="border-none">
                  <h1 v-if="copyClinicalPercent(concern.title)">
