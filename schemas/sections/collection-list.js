import { collectionListCarousel } from 'presets/collection-list-carousel';
import { collectionListGrid } from 'presets/collection-list-grid';
import { collectionListBento } from 'presets/collection-list-bento';
import { collectionListEditorial } from 'presets/collection-list-editorial';
...
export default {
  ...
  settings: [
    ...
    },
    {
      ...
      label: 't:settings.mobile_columns',
      options: [
        { value: '60cqw', label: 't:options.one_number' },
        { value: '44cqw', label: 't:options.two_number' },
      ],
      default: '60cqw',
  ...
  presets: [collectionListBento, collectionListGrid, collectionListCarousel, collectionListEditorial],
};
