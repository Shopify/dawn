...
You can follow this [quick start guide for theme developers]([https://github.com/Shopify/shopify-cli#quick-start-guide-for-theme-developers](https://shopify.dev/docs/themes/tools/cli)) to get started.
