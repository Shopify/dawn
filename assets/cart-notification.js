class CartNotification extends HTMLElement {
  constructor() {
    ...
    /* open cart drawer instead of notification
    ...
    /* need to be editable after drawer shown, so i commented this section
  ...
  open() {
   ...
   document.body.classList.add('is-drawer-opened');
  }
