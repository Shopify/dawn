...
| LP1-06 | Support | Public support address, recipient mailbox, published hours and Store Owner operating model are approved; LP-3B.5 was environment-blocked because Shopify rejected the local proxy after human hCaptcha completion | P1 | LP-3B.4 approval register, merchant Outlook verification and LP-3B.5 test record | Run one separately approved merchant-operated Shopify-hosted/normal-browser Contact test; do not alter verification controls | Store Owner | Hosted controlled Contact test | Pending technical test |
...
| LP1-15 | Contact operations | Contact page is published and renders correctly; LP-3B.5 was environment-blocked at Shopify connection verification, so submission, acknowledgement and routing remain untested | P1 | LP-3B.4 approval register, merchant mailbox evidence and LP-3B.5 test record | Run one separately approved merchant-operated hosted test; complete privacy/legal review | Store Owner | LP1-06, legal review | Pending technical and professional confirmation |
