...
| LP1-06 | Support | Public support address, recipient mailbox, published hours and Store Owner operating model are approved; Shopify Contact-form delivery, acknowledgement and spam routing remain unverified | P1 | LP-3B.4 approval register and manual Outlook send/receive verification | Run one separately approved synthetic Contact-form test and record Inbox/Junk delivery and storefront acknowledgement | Store Owner | Controlled Contact test | Pending technical test |
...
| LP1-15 | Contact operations | Contact page is published; public address, recipient mailbox, Store Owner ownership, acknowledgement and spam-review process are approved, but form delivery, success behaviour and privacy presentation remain unverified | P1 | LP-3B.4 approval register and manual mailbox verification | Run one controlled synthetic form test and complete privacy/legal review | Store Owner | LP1-06, legal review | Pending technical and professional confirmation |
