...
| LP1-03c | Unpublished support pages | Draft copy is aligned to R770 and LP-3B.3 recommends internal procedures, but publication, policy and operational gates remain | P1 | LP-3B.1/3B.2/3B.3 decision package | Assign/approve the procedures and close page-specific supplier, provider, technical, tax and legal gates before publication | Merchant / content owner | LP1-03b, LP1-05, LP1-06, LP1-10 | Drafted but unpublished |
