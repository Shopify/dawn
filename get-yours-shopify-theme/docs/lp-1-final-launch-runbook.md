...
| 16. Contact readiness | LP-3B.5C found native submissions route to a different private Sender email; sender fallback and acknowledgement mismatch also remain | Decide and separately approve destination/sender correction, locale-copy alignment and one hosted retest | Destination misaligned, delivery absent, acknowledgement misaligned, or privacy issue | LP-3B.5B/5C records and merchant mailbox observation | Store Owner | Separate approval |
