...
| Contact | Published form; partially approved, not operationally ready | Public address, recipient mailbox, Store Owner ownership, hours and acknowledgement are approved. LP-3B.5 was environment-blocked after human hCaptcha completion because Shopify rejected the local proxy at connection verification. Rendering passed; submission, acknowledgement, delivery, spam routing and final privacy wording remain unverified. |
